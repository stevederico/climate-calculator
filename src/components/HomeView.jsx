...
export default function HomeView() {
  ...
  const [bayBridgeTolls, setBayBridgeTolls] = useState(0);
    ...
    <>
      ...
      <div className="p-4 max-w-2xl mx-auto">
        ...
        <div className="mb-3 border px-3 pt-2 rounded">
          ...
          <div className="mb-3 border px-3 pt-2 rounded">
            <label className="block mb-1 text-sm text-gray-400">Bay Bridge Tolls</label>
            <div className="flex items-beginning">
              <div className="text-xl mr-1">$</div>
              <input
                type="text"
        ...
        <h3 className="text-xl my-4 mt-12">EV Vehicle Costs (Monthly)</h3>
